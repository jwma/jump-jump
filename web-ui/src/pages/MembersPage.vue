...
<template>
  <div>
    ...
    <div v-if="!loading" class="mt-6 text-right">
      <button
        class="text-sm text-gray-400 dark:text-gray-500 transition-colors hover:text-gray-600 dark:hover:text-gray-300"
    ...
    >
      ...
      <div class="mt-3 rounded-lg border bg-gray-50 dark:bg-gray-800/50 p-3 text-xs text-gray-600 dark:text-gray-400">
        ...
        <ul v-else class="mt-1 list-inside list-disc space-y-0.5 text-gray-500 dark:text-gray-400">
