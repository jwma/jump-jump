  ...
  <Teleport to="body">
    <div v-if="open" class="fixed inset-0 z-[60] flex items-start justify-center pt-[15vh]">
      ...
      >
        <!-- Search input -->
        <div
          class="flex items-center gap-3 border-b border-gray-100 dark:border-gray-800 px-4 py-3"
        >
        ...
        <div v-if="query.trim()" class="max-h-72 overflow-y-auto">
          ...
          <ul v-else-if="hasResults">
            ...
            >
              ...
              <span
                class="shrink-0 rounded-full bg-gray-100 dark:bg-gray-800 px-2 py-0.5 text-[10px] font-medium text-gray-500 dark:text-gray-400"
              >
