...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateShortLinkAPIRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.CreateShortLinkAPIResponseData"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.GetShortLinkAPIResponseData"
                                        }
                                    }
                                }
                            ]
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateShortLinkAPIRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.UpdateShortLinkAPIResponseData"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.ShortLinkDataAPIResponseData"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.GetUserInfoAPIResponseData"
                                        }
                                    }
                                }
                            ]
        ...
        "/user/preferences": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "data.preferences 为 []*models.UserPreference",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/models.Response"
    ...
    "definitions": {
        ...
        "models.CreateShortLinkAPIRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "models.CreateShortLinkAPIResponseData": {
            "type": "object",
            "properties": {
                "shortLink": {
        ...
        "models.GetConfigAPIResponseData": {
            "type": "object",
            "properties": {
                "config": {}
            }
        },
        "models.GetShortLinkAPIResponseData": {
            "type": "object",
            "properties": {
                "shortLink": {
                    "$ref": "#/definitions/models.ShortLinkData"
        ...
        "models.ListShortLinksAPIResponseData": {
            "type": "object",
            "properties": {
                "shortLinks": {
                    "type": "array",
        ...
        "models.ShortLinkDataAPIResponseData": {
            "type": "object",
            "properties": {
                "daily": {
                    "type": "array",
        ...
        "models.UpdateShortLinkAPIRequest": {
            "type": "object",
            "required": [
                "url"
            ],
        ...
        "models.UpdateShortLinkAPIResponseData": {
            "type": "object",
            "properties": {
                "shortLink": {
                    "$ref": "#/definitions/models.ShortLinkData"
